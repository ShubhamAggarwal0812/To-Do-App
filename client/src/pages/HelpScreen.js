...
import { FaQuestionCircle, FaTasks, FaEdit, FaCheck, FaEnvelope } from 'react-icons/fa';
  ...
  return (
    <div className="container mx-auto p-6 mt-10 bg-white rounded shadow-md">
      ...
      <div className="text-center mb-6">
        <FaQuestionCircle className="text-blue-600 inline-block mb-4" size={60} />
      ...
      <p className="text-gray-700">
        If you need further assistance, please contact our support team at <a href="mailto:support@todoapp.com" className="text-blue-500 hover:underline">support@todoapp.com</a>.
      </p>
    </div>
  );
};
