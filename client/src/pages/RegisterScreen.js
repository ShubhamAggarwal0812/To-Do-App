...
const RegisterScreen = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const { data: responseData } = await axios.post('/api/users/accounts', { firstName, lastName, email, password });
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-4 bg-white shadow-lg rounded-lg mb-8">
      ...
      <img src={registerImage} alt="Register" className="mx-auto mb-4 w-24 h-24" />
